...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="h-screen relative overflow-hidden flex items-center justify-center bg-black dark:bg-black transition-colors duration-300"
    >
      ...
      <div className="max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8 z-10">
        ...
        >
          <motion.h1 
            className="text-6xl md:text-8xl font-bold font-poppins mb-4 text-white leading-tight"
            initial={{ y: 20 }}
            animate={{ y: 0 }}
        ...
        >
          Where <span className="text-blue-400">imagination</span> meets <span className="text-blue-400">innovation</span>, creating futuristic designs that captivate and inspire the digital landscape.
        </motion.p>
        ...
        >
          <motion.a 
            href="#contact"
            className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium text-white bg-transparent rounded-full border border-blue-500 transition-all duration-300"
